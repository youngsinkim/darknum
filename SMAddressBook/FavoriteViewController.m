...
@property (strong, nonatomic) NSManagedObjectContext *childMoc;
...
- (void)viewDidLoad
{
    ...
    if (_mainMoc == nil) {
        ...
        _childMoc = [[NSManagedObjectContext alloc] initWithConcurrencyType:NSPrivateQueueConcurrencyType];
        [_childMoc setParentContext:_mainMoc];
